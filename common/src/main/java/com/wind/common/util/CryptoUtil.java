...
public class CryptoUtil {
     ...
     */
    public static boolean validatePassword(String password, String dbPassword, String correctHash)
            throws NoSuchAlgorithmException, InvalidKeySpecException {
        if (StringUtil.isBlank(password) || StringUtil.isBlank(dbPassword) || StringUtil.isBlank(correctHash)) {
            return false;
        }
        return validatePassword(password.toCharArray(), dbPassword, correctHash);
    }
     ...
     * @return true if the password is correct, false if not
     */
    private static boolean validatePassword(char[] password, String dbPassword, String correctHash)
            throws NoSuchAlgorithmException, InvalidKeySpecException {

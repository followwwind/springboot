...
public class Servlets {
	...
	public static final String STATIC_FILES = ".css,.js,.png,.jpg,.gif,.jpeg,.bmp,.ico,.swf,.psd,.htc,.htm,.html,.crx,.xpi,.exe,.ipa,.apk";
    ...
    public static boolean isStaticFile(String uri){
		if (StringUtils.endsWithAny(uri, STATIC_FILES) && !StringUtils.endsWithAny(uri, ".jsp") && !StringUtils.endsWithAny(uri, ".java")){
			return true;
		}
		return false;
    }
